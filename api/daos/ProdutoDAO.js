module.exports = {
    ...
    async create(params){
        sails.getDatastore().sendNativeQuery('SELECT id FROM produtos ORDER BY id DESC LIMIT 1;', [], function(e, firstResult) {
            ...
            sails.getDatastore().sendNativeQuery('INSERT INTO produtos(id, descricao, preco, foto, quantidade) VALUES($1, $2, $3, $4, $5);' , [lastId + 1, params.descricao, params.preco, params.foto, params.quantidade] ,function() {
